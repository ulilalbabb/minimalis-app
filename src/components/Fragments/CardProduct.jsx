...
const FooterCard = (props) => {
    ...
    return (
        <div className="flex items-center justify-between pb-3 px-2">
            ...
            <Button 
                variant="border border-amber-950 text-amber-950 hover:bg-amber-950 hover:shadow-3xl hover:text-white hover:translate-y-[-3px] transition-transform duration-300 px-3 text-xs lg:text-sm py-2"
